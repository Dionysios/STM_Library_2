...
#include "../../../qstlink2/include/devices.h"
...
static const char qt_meta_stringdata_DeviceList[] = {
    "DeviceList\0"
};

const QMetaObject DeviceList::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_DeviceList,
      qt_meta_data_DeviceList, 0 }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &DeviceList::getStaticMetaObject() { return staticMetaObject; }
#endif //Q_NO_DATA_RELOCATION
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_DeviceList))
